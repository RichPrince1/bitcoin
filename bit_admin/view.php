    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a style="background-color:#006" class="navbar-brand" href="index.php"><?php webname(); ?></a> 
            </div>
...
font-size: 16px;"><?php echo $_SESSION['name']; ?> &nbsp; <a href="logout.php" style="background-color:#006" class="btn square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                    <?php 
                                    $da = mysqli_query($db, "select * from bit_trans where id='$id'");									
									$tr = "";
									$i = 1;
                ...
                <?php 
				if ($ev == "image"){
				echo "<img src='../evidence_images/$evidence' class='img-responsive'>";
				}else{
				echo"<h3>$evidence</h3>";	
				}
				?>

            ...
            <div id="page-inner">
                <div class="row">
                        ...
                        <div class="col-lg-12">
                                    ...
                                    Search By Email:
                                    <form method="post" action="memtrack.php">
                                    <input type="text" name="email" class="form-control"><br>
                                    <input type="submit" value="Search" name="memtrack" class="btn btn-primary">
                                    </form>
                                    </div>
                                    </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php 
                                    $da = mysqli_query($db, "select * from bit_members order by id desc");									
									$tr = "";
									$i = 1;
                                    $block = "Block";

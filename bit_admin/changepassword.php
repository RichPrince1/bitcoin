...
font-size: 16px;"><?php echo $_SESSION['name']; ?> &nbsp; <a href="logout.php" style="background-color:#006" class="btn square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                                  	<h3 class="page-header">Change Your Admin Password Here</h3>
                                    <form method="post">
                                    ...
                                    <div class="form-group">
                                    <div class="col-lg-6">
                					<input class="btn btn-primary" type="submit" name="chuser" value="Change">                    				</div>
                                    </div>
                                    </form>
...
if (isset($_POST['chuser'])){
	...
	$q = mysqli_query($db, "select * from bit_admin where username='admin' and password='$old'");
	...
	$pass=md5($pass);
	$up = mysqli_query($db, "update bit_admin set password='$pass' where username='admin'");
	if($up){

            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a style="background-color:#006" href="sell.php"><i class="fa fa-laptop fa-3x"></i>Sell</a>
                    </li>	
					<li>
...
<div class="row">
<div class="col-md-12">
              	<h3 class="page-header">Please pay <?php echo $pricepay; ?>BTC to the wallet details below</h3>
      			 <form method="post" name="converter" enctype="multipart/form-data">
           		<div class="col-lg-12">
                <div class="col-lg-5">
                <textarea class="form-control" disabled><?php echo $wallet; ?></textarea>
      			</div>
                </div>
                <br><br>
                <div class="col-lg-6">
                ...
                Originating Bitcoin Address<input type="radio" name="ev" value="track">
